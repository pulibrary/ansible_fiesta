...
Princeton Library](https://github.com/pulibrary/ubuntubionicimage) one. We have
disabled the dependencies from Ansible Galaxy, we added a few more instructions
to ansible-lint to make the output less verbose.
